 ...
 * @author jahziah
 */
public class WidgetDownloadPanel extends javax.swing.JPanel implements ActionListener {

    /** Creates new form DownloadPanel */
    public WidgetDownloadPanel() {
        initComponents();
    }
    ...
    public void actionPerformed(java.awt.event.ActionEvent evt) {
        if (evt.getSource() == jButton1) {
            WidgetDownloadPanel.this.jButton1ActionPerformed(evt);
        }
